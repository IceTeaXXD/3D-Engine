...
export class HollowPrismGeometry extends BufferGeometry {
  ...
  createPrismVertices() {
    ...
    for (let i = 0; i < this.side; i++) {
      ...
      let _topHoleNext = _innerHoleTopVertices.slice(
        3 * nextAng,
        3 * nextAng + 3
      )
      let _botNext = _outerBottomVertices.slice(3 * nextAng, 3 * nextAng + 3)
      let _botHoleNext = _innerHoleBottomVertices.slice(
        3 * nextAng,
        3 * nextAng + 3
      )
      ...
      let _innerBottom = findPointInBetween(
        _X,
        _Y,
        _XnextAng,
        _YnextAng,
      ...
      let _innerTop = findPointInBetween(
        _X,
        _Y,
        _XnextAng,
        _YnextAng,
    ...
    const allVertices = [...TopVertices, ...BottomVertices, ...SideVertices]
